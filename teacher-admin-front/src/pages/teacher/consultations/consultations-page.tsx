  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
        ...
        {!consultationLoading && !consultationError && consultations.length > 0 && (
                ...
                >
                  ...
                  <div className="mt-3 grid grid-cols-1 gap-2 text-sm text-slate-500 sm:grid-cols-2">
                    <span className="rounded-xl bg-white px-3 py-2">
                      상담일 <strong className="ml-1 font-semibold text-slate-800">
                        {formatDate(item.consultationDate)}
                      </strong>
                    </span>
                    <span className="rounded-xl bg-white px-3 py-2">
                      다음 계획일 <strong className="ml-1 font-semibold text-slate-800">
      ...
      {editingConsultation && (
        <ModalFormShell
          title="상담 수정"
          description={`${editingConsultation.studentName} · ${editingConsultation.studentNumber}`}
