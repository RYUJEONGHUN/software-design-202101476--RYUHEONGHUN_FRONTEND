  ...
  return (
    <div className="space-y-8">
              ...
              {feedbacks.map((feedback) => (
                ...
                >
                  ...
                  <div className="mt-3 rounded-xl bg-white px-4 py-3">
                    <p className="text-sm leading-6 text-slate-700">{feedback.content}</p>
                  </div>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="h-9 rounded-xl bg-white px-4 text-sm font-semibold text-slate-700 hover:bg-slate-100"
                    >
                      수정
                    </button>
                  </div>
      ...
      {editingFeedback && (
        <ModalFormShell
          title="피드백 수정"
          description="카테고리, 공개 여부, 피드백 내용을 수정합니다."
